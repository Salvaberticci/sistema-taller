        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            @if(Auth::user()->role !== 'mechanic')
                ...
                @if($order->status === 'completed' || $order->status === 'ready')
                    <button type="button" disabled class="px-4 py-2 bg-slate-700 text-slate-400 font-bold rounded-xl cursor-not-allowed flex items-center gap-2 text-sm" title="Próximamente: notificación por correo y WhatsApp">
